...
typedef struct _EXITREASONCRACCESS {
    union {
        struct {
            DWORD64 CRX : 4;
            DWORD64 AccessType : 2;
            DWORD64 LMSWOperandType : 1;
            DWORD64 Reserved_1 : 1;
            DWORD64 Reg : 4;
            DWORD64 Reserved_2 : 4;
            DWORD64 LMSW : 16;
            DWORD64 Reserved_3 : 32;
        };
        LARGE_INTEGER u;
    };
...
extern "C" {
    ...
    void _vmwrite(DWORD32 dw32Field_, DWORD32 dw32Value_);
    DWORD32 _vmread(DWORD32 dw32Field_);
    void _vmclear(DWORD32 dw32LowPart_, DWORD32 dw32HighPart_);
    void _vmptrld(DWORD32 dw32LowPart_, DWORD32 dw32HighPart_);
    void _vmlaunch();
    void _vmcall();
    void _vmresume();
